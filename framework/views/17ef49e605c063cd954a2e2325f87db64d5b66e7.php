 <section id="register" class="register" style="background-image: url('<?php echo e($config_general['background_form'] ?? ''); ?>') !important;">
    <div class="register-container">
        <h2 class="section-title register-title"><?php echo e($title ?? 'ĐĂNG KÝ TƯ VẤN MIỄN PHÍ'); ?></h2>
        <div class="register-form col-gird-6">
            <div class="form-item">
                <input type="text" class="register-form-item form-control" name="name" placeholder="Họ và tên*" aria-label="Họ và tên" title="Họ và tên">
                <p class="err_show null">Họ và Tên là bắt buộc!</p>
            </div>
            <div class="form-item">
                <input type="text" class="register-form-item form-control" name="phone" placeholder="Số điện thoại*" aria-label="Số điện thoại" title="Số điện thoại">
        ...
        <div class="flex-center">
            <button type="button" class="btn btn-primary register-action fs-18" name="register-action" onclick="loadSendForm('register')" data-type="1" aria-label="Gửi" title="Gửi">Đăng ký</button>
        </div>
    </div>
</section>
<?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/web/layouts/register.blade.php ENDPATH**/ ?>