    ...
    <div class="container">
        ...
        <div class="should-choose-list col-gird-4">
            <?php $__currentLoopData = $setting_home['should_choose']['title']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('Default::web.layouts.should-choose_item_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
<?php endif; ?>
<?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/web/layouts/should-choose_home.blade.php ENDPATH**/ ?>