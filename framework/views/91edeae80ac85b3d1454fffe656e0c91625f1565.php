...
<header class="header <?php echo e(Route::getCurrentRoute() != null && Route::getCurrentRoute()->uri() == '/' ? 'home header_home' : ''); ?>">
    <div class="header-top flex-center-between">
        ...
        <div class="header-top__left flex-center">
            <a href="tel:<?php echo e($config_general['hotline_support'] ?? ''); ?>" rel="nofollow" aria-label="Hotline: <?php echo e($config_general['hotline_support'] ?? ''); ?>" class="flex-center">
                ...
                <span class="ml-5 lh-20 f-w-b color_white"> Hotline: <?php echo e($config_general['hotline_support'] ?? ''); ?></span>
            </a>
            <p class="address">
                ...
                <span class="ml-5 lh-20 f-w-b color_white"><?php echo e($config_general['address'] ?? ''); ?></span>
            </p>
        </div>
        <div class="header-top__right">
            <a href="<?php echo $config_general['link_intro'] ?? ''; ?>" class=" f-w-b color_white" rel="nofollow" aria-label="<?php echo $config_general['intro'] ?? ''; ?>"><?php echo $config_general['intro'] ?? ''; ?></a>
        </div>
    </marquee>
    </div>
        ...
        <div class="container"> 
           <div class="flex-center-between w-100">
                <div class="header-logo">
                    <a href="<?php echo e(route('app.home')); ?>" aria-label="logo">
                ...
                <nav class="header-menu flex">
                    ...
                    <?php if(count($primary_menu)): ?>
                    <ul class="header-menu__list flex-center">
                        <?php $__currentLoopData = $primary_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_lv1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="menu-item <?php echo e(isset($menu_lv1['children']) && count($menu_lv1['children']) > 0 ? 'has-child' : ''); ?>">
                            <a class="menu-item__link fs-15 f-w-b lh-18" rel="<?php echo e($menu_lv1['rel'] ?? ''); ?>" href="<?php echo e($menu_lv1['link']??''); ?>" target="<?php echo e($menu_lv1['target'] == '_blank' ? 'blank' : '_self'); ?>">
                                <?php echo $menu_lv1['name']??''; ?>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" fill="#69727d"><!--! Font Awesome Free 6.4.2 by @fontawesome  - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
                                <ul class="submenu has_child">
                                    ...
                                    <li class="submenu-item">
                                        <a class="submenu-item__link fs-14 f-w-b" rel="<?php echo e($menu_lv2['rel'] ?? ''); ?>" href="<?php echo e($menu_lv2['link'] ?? '#'); ?>" target="<?php echo e($menu_lv2['target'] == '_blank' ? '_blank' : '_self'); ?>">
                                            <?php echo $menu_lv2['name']??''; ?>
                ...
                <div class="header-search">
                    <a href="tel:<?php echo e($config_general['hotline_support'] ?? ''); ?>" class="btn btn-primary reason-btn btn-hotline" aria-label="Dặt xe ngay" title="Đặt xe ngay">Đặt xe ngay</a>
                </div>
           </div>
        </div>
    </div>
</header>
<?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/web/layouts/header.blade.php ENDPATH**/ ?>