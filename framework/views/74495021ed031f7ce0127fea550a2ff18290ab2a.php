...
<footer>
        <div class="footer-center w-100">
            ...
            <div class="footer-top-logo footer-item text-center">
                <a href="<?php echo e(route('mobile.home')); ?>" aria-label="logo footer">
                ...
                <div class="footer-item">
                    <div class="footer-item__title f-w-b fs-18 lh-35 color_white"><?php echo e($config_general['company_name'] ?? 'Về chúng tôi'); ?></div>
                    ...
                    <div class="footer-item__group">
                        ...
                        <div class="footer-item__icon">
                            <?php if(isset($config_general['social']['social_item_link']) && count($config_general['social']['social_item_link']) > 0): ?>
                                ...
                                <div class="icon-item">
                                    <p><?php echo e(isset($config_general['about_description']) ? $config_general['about_description'] : ''); ?></p>
...
<?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/mobile/layouts/footer.blade.php ENDPATH**/ ?>