                ...
                <div class="post-left">
                    ...
                    <div class="post-left__content mt-30">
                        <div class="post-list"  id="listdata">
                            <?php echo $__env->make('Default::mobile.post.listdata', ['posts' => $posts], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="mt-20">
                ...
                <div class="post-right mt-30">
                    <div class="sidebar">
                        ...
                        <div class="sidebar__blog">
                            ...
                            <div class="blog-list">
                                <?php echo $__env->make('Default::mobile.layouts.blog_item', ['posts'=> $post_news], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('Default::mobile.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/mobile/post/index.blade.php ENDPATH**/ ?>