                ...
                <div class="info_social">
                    ...
                    <ul class="info_social__list flex">
                        <li class="social_item facebook flex">
                            <a href="<?php echo e($config_general['facebook'] ?? '/'); ?>" aria-label="facebook" rel="nofollow" class="flex" target="_blank">
                        ...
                        <li class="social_item twitter flex">
                            <a href="<?php echo e($config_general['twitter'] ?? '/'); ?>" aria-label="twitter" rel="nofollow" class="flex" target="_blank">
                        ...
                        <li class="social_item pinterest flex">
                             <a href="<?php echo e($config_general['pinterest'] ?? '/'); ?>" aria-label="pinterest" rel="nofollow" class="flex" target="_blank">
                        ...
                        <li class="social_item instagram flex">
                             <a href="<?php echo e($config_general['instagram'] ?? '/'); ?>" aria-label="instagram" rel="nofollow" class="flex" target="_blank">
