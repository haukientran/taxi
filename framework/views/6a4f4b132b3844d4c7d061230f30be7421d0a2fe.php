...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(asset('./assets/font/Averta/averta.min.css?v='.config('SudoAsset.vesion'))); ?>"> -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/build/css/general.min.css?v='.config('SudoAsset.vesion'))); ?>">
</head>
<body>
    
    <?php echo $__env->make('Default::general.layouts.adminbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    
    <?php echo $__env->make('Default::web.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('Default::web.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <section id="loading_box"><div id="loading_image"></div></section>
...
<?php /**PATH /var/home/themes/default/src/Providers/../../resources/views/web/layouts/app.blade.php ENDPATH**/ ?>