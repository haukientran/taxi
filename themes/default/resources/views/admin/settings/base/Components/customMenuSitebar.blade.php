			...
			<div class="collapse" data-toggle_box>
				<div class="card-body">
			    	...
			    	<div class="form-group mb-0 text-right">
			    		<button type="button" class="btn btn-primary btn-menu-submit {!! $name ?? '' !!}" data-type="{!! $type ?? '' !!}" data-name="{!! $name ?? '' !!}"><i class="fa fa-plus mr-2"></i>@lang('Translate::form.menu.add_menu')</button>
			    	</div>
				</div>
			</div>
		</div>
