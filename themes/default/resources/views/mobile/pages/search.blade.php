		...
		<div class="page w-100 mb-30 mt-30">
            ...
            <div class="page-left__detail">
                @if( isset($study_abroads) && count($study_abroads) > 0)
					<div class="post-list flex mt-30" id="listdata">
						@include('Default::mobile.layouts.item_search', ['study_abroads' => $study_abroads])
					</div>
				...
				@else
					<div class="search-product__default w-100">
						<p class="fs-16" style="font-style: italic; color: red;">Không tìm thấy sản phẩm phù hợp với từ khóa !</p>
						<a href="{{ route('mobile.home') }}" class="fw-600" style="color: rgba(1, 119, 237, 1);text-decoration: underline;margin-top: 10px;display: block;text-transform: uppercase;"> Về trang chủ</a>
					</div>
				@endif
            </div>
		</div>
