        ...
        <div class="popup-content__body">
            <form id="popup-register">
                ...
                <div class="register-form">
                    ...
                    <div class="form-item">
                        <select name="country" class="register-form-item form-control" aria-label="{{ isset($config_general['country_title']) ? $config_general['country_title'] : 'Quốc gia bạn muốn du học' }}">
                    ...
                    <div class="form-item">
                        <select name="educational" class="register-form-item form-control" aria-label="{{ isset($config_general['educational_title']) ? $config_general['educational_title'] : 'Bậc học quan tâm' }}">
