...
<section id="evaluate" style=" background-color :{{ isset($config_general['color_backgroud']) ? $config_general['color_backgroud'] : '#363636' }}">
    <div class="container evaluate-container">
        <h2 class="section-title evaluate-title">{!! $config_general['reviews_title'] ?? '' !!}</h2>
