...
<footer>
        <div class="footer-center w-100">
            <div class="container">
            <div class="footer-top-logo footer-item text-center">
                ...
                <div class="footer-item">
                    <div class="footer-item__title f-w-b fs-18 lh-35 color_white">{{ $config_general['company_name'] ?? 'Về chúng tôi' }}</div>
