...
@section('head')
	...
	<link rel="stylesheet" href="/assets/build/css/page_mb.min.css">
@endsection
@section('content')
	<main class="error">
        <div class="container">
        	<div class="error-404 w-100 text-center">
				<div class="error-404__box">
					...
					<a href="{{ route('mobile.home') }}" aria-label="Trang chủ" class="button button__primary color_white text-up fs-16 f-w-b">{{ __('Về trang chủ') }} </a>
				</div>
    			<img src="{{ $config_general['404_image'] ?? '/assets/images/image-404_mb.png' }}" alt="Image 404">
        	</div>
        </div>
    </main>
@endsection
