<div class="should-choose-item flex-center-between">
    <div class="should-choose-item__thumbnail">
        @include('Default::general.components.image', [
            'src' => resizeWImage($setting_home['should_choose_grid2_star']['image'][$key] ?? '', 'w100'),
            'width' => '80',
            'height' => '80',
            "lazy"   => true,
            'title'  =>  'icon_leanh'
    ...
    <div class="should-choose-item__content">
        ...
        <div class="should-choose-item__desc four-lines-ellipsis">{{ isset($setting_home['should_choose_grid2_star']['description'][$key]) ? $setting_home['should_choose_grid2_star']['description'][$key] : '' }}</div>
    </div>
</div>
