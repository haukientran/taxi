...
<footer>
        <div class="footer-center w-100">
            ...
            <div class="footer-top-logo footer-item">
                <a href="{{ route('app.home') }}" aria-label="logo footer">
                ...
                <div class="footer-item">
                    <div class="footer-item__title f-w-b fs-18 lh-35">{{ $config_general['company_name'] ?? 'Về chúng tôi' }}</div>
                    ...
                    <p class="footer-item__text color_white flex-center-left">
                        ...
                        <a class="color_white" href="tel:{{ $config_general['hotline_support'] ?? '' }}" rel= "nofollow" title="{{  $config_general['hotline_support'] ?? '' }}" aria-label="Hotline">
                             {!! $config_general['hotline_support'] ?? '' !!}
                        </a>
                    </p>
                    <p class="footer-item__text flex-center-left">
                        ...
                        <a class="color_white" href="mailto:{{ $config_general['email'] ?? 'ewh-info@eurowindow-holding.com' }}" rel= "nofollow" title="{{  $config_general['email'] ?? 'ewh-info@eurowindow-holding.com' }}" aria-label="email">
    ...
    @if(isset($config_general['contact']['contact_link']) && count($config_general['contact']['contact_link']) > 0) > 0)
    <div class="contact">
