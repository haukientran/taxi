	...
	@foreach($posts as $post)
        <div class="post-item">
            <div class="post-item__thumbnail">
                <a href="{{ $post->getUrl() }}" aria-label="{!! $post->name ?? '' !!}">
            ...
            <div class="post-item__content">
                ...
                {{-- <a href="{{ $post->getUrl() }}" class="btn btn-primary w-100 post-item__see" aria-label="Xem chi tiết khóa học" title="Xem chi tiết khóa học">XEM CHI TIẾT</a> --}}
            </div>
        </div>
    @endforeach
@endif
