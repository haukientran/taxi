    ...
    @foreach($study_abroads as $study_abroad)
        <div class="post-item">
            <div class="post-item__thumbnail">
                <a href="{{ $study_abroad->getUrl() ?? '' }}" aria-label="{!! $study_abroad->name ?? '' !!}">
            ...
            <div class="post-item__content">
                <a href="{{ $study_abroad->getUrl() ?? '' }}" aria-label="">
                ...
                {{-- <a href="{{ $study_abroad->getUrl() ?? '' }}" class="btn btn-primary w-100 post-item__see" aria-label="Xem chi tiết khóa học" title="Xem chi tiết khóa học">XEM CHI TIẾT</a> --}}
            </div>
        </div>
    @endforeach
@endif
