<div class="member-item" data-thumnail="">
   <div class="member-item__top">
    <a href="{{ $personnel->getUrl() ?? '' }}" area-label="Xem chi tiết">
    ...
    <div class="member-item__info">
        <h3 class="name text-up f-w-b mb-15 text-center">
            {{ $personnel->name ?? '' }}
        </h3>
        <div class="detail mb-8">
            {!! cutString(removeHTML($personnel->description ), 200) ?? '' !!}
        </div>
        <a class="text-center" href="{{ $personnel->getUrl() ?? '' }}" area-label="Xem chi tiết">
            Xem chi tiết
        </a>
    </div>
</div>
