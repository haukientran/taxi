<section id="register_study_abroad" class="register mt-30">
    <div class="register-container">
        <h2 class="section-title">{{ $title ?? 'Đăng ký tư vấn miễn phí' }}</h2>
        <div class="register-form col-gird-6">
            ...
            <div class="form-item">
                <select name="province" class="register-form-item form-control">
            ...
            <div class="form-item">
                <select name="course" class="register-form-item form-control">
        ...
        <div class="flex-center">
            <button class="btn btn-primary register-action fs-18" name="register-action" onclick="loadSendForm('register_study_abroad')" data-type="2" aria-label="Gửi" title="Gửi">Gửi</button>
        </div>
    </div>
</section>
