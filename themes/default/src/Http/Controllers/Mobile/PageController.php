...
class PageController extends Controller
{
	...
	public function show($slug) {
		...
		return view('Default::mobile.pages.show',compact('page', 'admin_bar', 'meta_seo'));
    ...
    public function introduce() {
		...
		return view('Default::mobile.pages.introduce',compact('setting_introduce', 'admin_bar', 'meta_seo', 'setting_home', 'personnels'));
	}
    public function contact(Request $request){
		...
		$breadcrumb = [
			[
				'name' =>'Liên hệ',
				'link' =>route('mobile.contact'),
			]
		];
        $admin_bar = route('admin.settings.contact');
        return view('Default::mobile.pages.contact', compact('meta_seo', 'config_contact', 'admin_bar', 'breadcrumb'));
    }
    public function admin_users($slug, Request $request) {
		...
		return view('Default::mobile.admin_users.show', compact(
