...
namespace Sudo\Translate\Providers;
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/translates');
            $this->publishes($assets, 'sudo/translates/assets');
            $this->publishes($config, 'sudo/translates/config');
            $this->publishes($view, 'sudo/etranslates/view');
