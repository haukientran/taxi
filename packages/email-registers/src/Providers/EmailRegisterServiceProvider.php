...
namespace Sudo\EmailRegister\Providers;
 
use Illuminate\Support\ServiceProvider;
use File;
class EmailRegisterServiceProvider extends ServiceProvider
{
    /**
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/email-register');
            $this->publishes($assets, 'sudo/email-register/assets');
            $this->publishes($config, 'sudo/email-register/config');
            $this->publishes($view, 'sudo/email-register/view');
